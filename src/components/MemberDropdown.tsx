...
const MemberDropdown: React.FC = () => {
  ...
  const ulStyled =
    "absolute xs:bottom-[60]  sm:bottom-0 sm:top-9 sm:top-full right-0 flex flex-col justify-center text-center xs:w-30 sm:w-32 bg-white shadow-lg xs:p-[0.2rem] sm:p-1 z-10 xs:max-h-24 sm:max-h-96  sm:overflow-y-auto rounded-md";
  ...
  return (
    <>
      {!isLoggedIn ? (
        <ul className={`${ulStyled} sm:min-h-[3rem]`}>
          <li>
